import { CategoryDef, Product } from './types';
...
export const MILK_OPTIONS = ["Обычное", "Кокосовое", "Банановое", "Миндальное", "Безлактозное"];
export const SYRUP_OPTIONS = ["Фисташка", "Лесной орех", "Кокос", "Миндаль", "Лаванда", "Малина", "Соленая карамель"];
export const JUICE_OPTIONS = ["Апельсиновый", "Вишневый"];
export const SUGAR_OPTIONS = ["5г", "10г", "15г"];
